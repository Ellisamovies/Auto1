...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002400670063 -1001750077160').split()]  # For Multiple Id Use One Space Between Each.
